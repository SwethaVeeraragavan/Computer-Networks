...
set val(x)      2576                      ;# X dimension of topography
...
set tracefile [open dsrtcp60newreno.tr w]
$ns trace-all $tracefile

#Open the NAM trace file
set namfile [open dsrtcp60newreno.nam w]
